...
<div align="center">
  <img src="docs/screenshots/overview.png" width="880" alt="Soma 应用总览：首页进度、周期记录与设置页面拼接展示" />
</div>

<p align="center">
  <sub>应用总览：今日进度、周期记录与设置页面</sub>
</p>
...
<div align="center">
  <img src="docs/screenshots/goal-estimator.jpg" width="300" alt="Soma 自定义喝水目标：根据身体数据、活动量和饮食习惯估算每日饮水目标" />
</div>

<p align="center">
  <sub>自定义喝水目标：根据身体数据、活动量和饮食习惯估算更适合自己的每日目标</sub>
</p>
